...
@interface page4VC ()<AVCaptureMetadataOutputObjectsDelegate,CAAnimationDelegate>
{
...
- (void)setOverlayPickerView
{
   ...
   // [cancleBtn setImage:[UIImage imageNamed:@"fanhui.png"] forState:UIControlStateNormal];
    ...
    centerView.image = [UIImage imageNamed:@"erweimakuang-2.png"];
    ...
    line.tag = line_tag;
    line.image = [UIImage imageNamed:@"hengxian2.png"];
...
- (void)addAnimation{
    ...
    line.hidden = NO;
    CABasicAnimation *animation = [page4VC moveYTime:2 fromY:[NSNumber numberWithFloat:0] toY:[NSNumber numberWithFloat:ScreenWidth-60-2] rep:OPEN_MAX];
